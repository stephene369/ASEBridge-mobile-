...
export async function getAccount() {
  try {
    ...
    console.log("No internet error", error);
    if (error instanceof Error && error.message.includes("AppwriteException: Failed to fetch")) {
      console.log("Move to checker")
      window.location.href = '/asebridge/internetcheck';
    }
  }
}
